...
function mrk_get_email_template() {
...
function mrk_clean_email_body( $message ) {
    $msg = preg_replace( '/^.*\<body[^\>]*\>/s', '', $message );
    $msg = preg_replace( '/\<\/body.*$/s', "\n", $msg );
    return $msg;
}
...
add_filter( 'mrk_rest_process_post',         'mrk_rest_add_rel_path'            );
add_filter( 'mrk_rest_process_post',         'mrk_rest_add_children',       999 );
add_filter( 'mrk_rest_process_post',         'mrk_rest_restrictions',       999 );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_rel_path'            );
add_filter( 'mrk_rest_process_media',        'mrk_rest_restrictions',       999 );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_kgvid_meta'          );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_stats'               );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_encoding_info'       );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_thumbnail',       11 );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_show_text',       11 );
add_filter( 'mrk_rest_process_media',        'mrk_rest_set_release_type'        );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_release_number'      );
add_filter( 'mrk_rest_process_media',        'mrk_rest_add_full_content'        );
add_filter( 'mrk_rest_process_home_page',    'mrk_rest_add_promo_reel'          );
add_filter( 'mrk_rest_process_program',      'mrk_rest_set_program_type'        );
add_filter( 'mrk_rest_process_program',      'mrk_rest_add_promo_reel'          );
add_filter( 'mrk_rest_process_program',      'mrk_rest_add_member_content'      );
add_filter( 'mrk_rest_process_program',      'mrk_rest_add_releases'            );
add_filter( 'mrk_rest_process_release',      'mrk_rest_add_bg_image'            );
add_filter( 'mrk_rest_process_release',      'mrk_rest_set_release_type'        );
add_filter( 'mrk_rest_process_release',      'mrk_rest_add_release_number'      );
add_filter( 'mrk_rest_process_release',      'mrk_rest_add_release_series'      );
