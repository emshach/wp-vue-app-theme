...
$border_top_radius = $settings['template'] == 'boxed' ? '2px' : '0px';
$template_container = "
...
$template_header = "
	...
	color: #f1f1f1;
	-webkit-border-top-left-radius:$border_top_radius !important;
	-webkit-border-top-right-radius:$border_top_radius !important;
	border-top-left-radius:$border_top_radius !important;
	border-top-right-radius:$border_top_radius !important;
	border-bottom: 0;
	font-family:Arial;
	font-weight:bold;
	line-height:100%;
        ...
        <tr>
          <td align="center" valign="top">
            <table border="0" cellpadding="0" cellspacing="0"
                   id="template_container" style="<?php echo $template_container; ?>">
              <tr>
                <td align="center" valign="top">
                  <!-- Header -->
		          ...
		          <a style="<?php echo $header_content_h1_a;?>" href="<?php echo apply_filters( 'mailtpl/templates/header_logo_url', home_url());?>" title="<?php echo apply_filters( 'mailtpl/templates/header_logo_url_title', !empty($settings['header_logo_text']) ? do_shortcode( strip_tags($settings['header_logo_text']) ) : get_bloginfo('name') );?>"><?php
		                                            if( !empty($settings['header_logo']) ) {
			                                            echo '<img style="'.$header_content_h1_img.'" src="'.apply_filters( 'mailtpl/templates/header_logo', $settings['header_logo'] ).'" alt="'. apply_filters( 'mailtpl/templates/header_logo_alt', !empty($settings['header_logo_text']) ? do_shortcode( strip_tags($settings['header_logo_text']) ) : get_bloginfo( 'description' ) ) .'"/>';
