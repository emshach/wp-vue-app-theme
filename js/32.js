    ...
    login: function login(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(this.ajaxUrl, qs__WEBPACK_IMPORTED_MODULE_2___default.a.stringify(this.loginForm), {
        ...
        switch (d.next) {
          ...
          case 'success':
            // success!
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default()('Successfully logged in! Welcome!');
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default()("We're sorry! There was some problem. Please try again later");
      });
      return false;
    },
