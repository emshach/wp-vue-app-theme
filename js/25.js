...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getConfirmation: function getConfirmation() {
      ...
      this.fetching = false;
      this.wait = window.setInterval(function () {
